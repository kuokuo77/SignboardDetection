...
def val_one_epoch(model, optimizer, loader, epoch):
    model.cuda()
    model.train()
...
#         lr_scheduler = optim.lr_scheduler.LinearLR(optimizer, start_factor = warmup_factor, total_iters=warmup_iters)
    ...
    for images, targets in tqdm(loader):
        ...
        vall_losses.append(loss_value)
        vall_losses_dict.append(loss_dict_append)
         
    vall_losses_dict = pd.DataFrame(vall_losses_dict) # for printing
    print("Epoch {}, lr: {:.6f}, loss: {:.6f}, loss_classifier: {:.6f}, loss_box: {:.6f}, loss_rpn_box: {:.6f}, loss_object: {:.6f}".format(
        epoch, optimizer.param_groups[0]['lr'], np.mean(vall_losses),
        vall_losses_dict['loss_classifier'].mean(),
        vall_losses_dict['loss_box_reg'].mean(),
        vall_losses_dict['loss_rpn_box_reg'].mean(),
        vall_losses_dict['loss_objectness'].mean()
    ))
    vloss.append(np.mean(vall_losses))
    vloss_classifier.append(vall_losses_dict["loss_classifier"].mean())
    vloss_box_reg.append(vall_losses_dict["loss_box_reg"].mean())
    vloss_rpn_box_reg.append(vall_losses_dict["loss_rpn_box_reg"].mean())
    vloss_objectness.append(vall_losses_dict["loss_objectness"].mean())    
...
torch.save(model, "/home/tonio1314/CVDL/kuokuo/signboard_detection/sb_dec5.pth")

fig = plt.figure()
plt.plot(loss, "-", color='orange')
plt.plot(vloss, "-", color='skyblue')
plt.legend(['train', 'validation'], loc='upper right')
plt.xlabel('epoch')
plt.ylabel('loss')
plt.savefig("/home/tonio1314/CVDL/kuokuo/signboard_detection/2_output/loss5.png")

fig = plt.figure()
plt.plot(loss_classifier, "-", color='orange')
plt.plot(vloss_classifier, "-", color='skyblue')
plt.legend(['train', 'validation'], loc='upper right')
plt.xlabel('epoch')
plt.ylabel('loss_classifier')
plt.savefig("/home/tonio1314/CVDL/kuokuo/signboard_detection/2_output/loss_classifier5.png")

fig = plt.figure()
plt.plot(loss_box_reg, "-", color='orange')
plt.plot(vloss_box_reg, "-", color='skyblue')
plt.legend(['train', 'validation'], loc='upper right')
plt.xlabel('epoch')
plt.ylabel('loss_box_reg')
plt.savefig("/home/tonio1314/CVDL/kuokuo/signboard_detection/2_output/loss_box_reg5.png")

fig = plt.figure()
plt.plot(loss_rpn_box_reg, "-", color='orange')
plt.plot(vloss_rpn_box_reg, "-", color='skyblue')
plt.legend(['train', 'validation'], loc='upper right')
plt.xlabel('epoch')
plt.ylabel('loss_rpn_box_reg')
plt.savefig("/home/tonio1314/CVDL/kuokuo/signboard_detection/2_output/loss_rpn_box_reg5.png")

fig = plt.figure()
plt.plot(loss_objectness, "-", color='orange')
plt.plot(vloss_objectness, "-", color='skyblue')
plt.legend(['train', 'validation'], loc='upper right')
plt.xlabel('epoch')
plt.ylabel('loss_objectness')
plt.savefig("/home/tonio1314/CVDL/kuokuo/signboard_detection/2_output/loss_objectness5.png")
